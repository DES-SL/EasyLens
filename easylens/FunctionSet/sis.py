...
class SIS(object):
    ...
    def function(self, x, y, phi_E, center_x=0, center_y=0):
        x_shift = x - center_x
        y_shift = y - center_y
        f_ = phi_E * np.sqrt(x_shift*x_shift + y_shift*y_shift)
        return f_

    def derivatives(self, x, y, phi_E, center_x=0, center_y=0):
        """
    ...
    def hessian(self, x, y, phi_E, center_x=0, center_y=0):
        """
    ...
    def all(self, x, y, phi_E, center_x=0, center_y=0):
        """
